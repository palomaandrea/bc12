package aut.testcreation.testcases.grupo1.Vuelos;
...
public class TC001 {
    ...
    @FindBy(xpath = "//button[contains(@class, 'iubenda-cs-accept-btn') and contains(@class, 'iubenda-cs-btn-primary') and contains(text(), 'Aceptar todo')]")
    WebElement btnAceptar;
    @FindBy(xpath = "//a[contains(text(),'Vuelos')]" )
    ...
    @Test
    void CP001_TC001_OK() throws InterruptedException {
        ...
        By locatorSoloIda = By.xpath("//form[contains(text(), 'Solo ida')]");
        WebElement btnSoloIda = wait.until(ExpectedConditions.presenceOfElementLocated(locatorSoloIda));
        btnSoloIda.click();

        //By locatorBtnOrigen = By.xpath("/html/body/div[1]/div[2]/div/div[2]/div/div/div[5]/div/div/div/div/div[2]/div/form/div/div[3]/fieldset/div[1]/div");
        //WebElement btnOrigen = wait.until(ExpectedConditions.presenceOfElementLocated(locatorBtnOrigen));
        //btnOrigen.click();
        //btnOrigen.sendKeys("La Rioja (IRJ) - Captain V. A. Almonacid, Argentina");
